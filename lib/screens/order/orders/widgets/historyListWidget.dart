...
class AllHistoryWidget extends StatelessWidget {
...
class CompletedHistoryWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
        ...
        scrollDirection: Axis.vertical,
        itemBuilder: (context, index) {
          return (demoHistory[index].completed == true)
              ? OrdersHistoryCard(
                  date: demoHistory[index].date,
                  buyerFirstName: demoHistory[index].buyerFirstName,
                  buyerLastName: demoHistory[index].buyerLastName,
...
class InProgressHistoryWidget extends StatelessWidget {
  const InProgressHistoryWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
        ...
        scrollDirection: Axis.vertical,
        itemBuilder: (context, index) {
          return (demoHistory[index].inProgress == true)
              ? OrdersHistoryCard(
                  date: demoHistory[index].date,
                  buyerFirstName: demoHistory[index].buyerFirstName,
                  buyerLastName: demoHistory[index].buyerLastName,
...
class CancelledHistoryWidget extends StatelessWidget {
  const CancelledHistoryWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
        ...
        scrollDirection: Axis.vertical,
        itemBuilder: (context, index) {
          return (demoHistory[index].cancelled == true)
              ? OrdersHistoryCard(
                  date: demoHistory[index].date,
                  buyerFirstName: demoHistory[index].buyerFirstName,
                  buyerLastName: demoHistory[index].buyerLastName,
