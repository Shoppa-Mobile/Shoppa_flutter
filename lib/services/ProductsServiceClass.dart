  ...
  Future<int> createNewProduct({
    ...
    try {
      ...
      formData.fields.addAll({
        ...
        if (colors != null && colors.isNotEmpty) 'colours': jsonEncode(colors),
      });
      ...
      if (e is TimeoutException) {
        ...
        // Handle other types of errors
        print('Error: $e');
        return 504; // Custom code to indicate an error
      }
    }
  }
      ...
      if (response.statusCode == 200) {
        ...
        return (products).map(
          (item) {
            ...
            for (var entry in images.entries) {
              ...
              imagesList.add(
                ImageModel(
                  ...
                  uuid: imageInfo['uuid'],
                  previewUrl: imageInfo['preview_url'],
                  originalUrl: imageInfo['original_url'],
                  order: imageInfo['order'],
                  customProperties:
                      List<String>.from(imageInfo['custom_properties']),
            ...
            final colorsList = item['colours'] as List<dynamic>;
            if (colorsList.isNotEmpty) {
              for (var colorInfo in colorsList) {
